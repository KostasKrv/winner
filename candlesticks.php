...
<body>
    ...
    try {
        ...
        foreach ($symbolDbRows as $symbolRow) :
            ...
            $ticks = $_BINANCE_API->candlesticks($symbol, "1h");
  ...
  */
                ...
                try {
                    ...
                    $_set = [
                        ...
                        'openTime' => $_oT->format($dateToFormat),
                    ];
                    ...
                    $_DB->exec(
                        "DELETE FROM $dbTableName WHERE openTime < ?",
